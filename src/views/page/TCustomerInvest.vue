...
<div class="table">
    ...
    <div class="handle-box">
		...
		<span>订单号：</span> <el-input v-model="searchForm.custome_invest_no" placeholder="订单号" class="handle-input mr10"></el-input>
		<span>&#12288&#12288订单金额:</span>
		<el-input v-model="searchForm.min_invest_amt" placeholder="金额" class="handle-input" type="number" min="0"></el-input>
		-
		<el-input v-model="searchForm.max_invest_amt" placeholder="金额" class="handle-input" type="number" min="0"></el-input>
		<span>&#12288&#12288渠道：</span>
		<el-select v-model="searchForm.channel_no" class="handle-select mr10" placeholder="请选择">
	...
	<div class="handle-box">
	     ...
	     <span>订单状态：</span>
		 <el-select v-model="searchForm.flag" class="handle-select mr10" placeholder="请选择">
			<el-option v-for="option in flag_options" :key="option. label" :value="option.value" :label="option. label">
			</el-option>
		 </el-select>
		 <span>&#12288&#12288订单成交时间:</span>
         <el-date-picker  v-model="searchForm.min_createtime":editable="false" type="datetime" placeholder="选择日期" ></el-date-picker>
         -
         <el-date-picker  v-model="searchForm.max_createtime":editable="false" type="datetime" placeholder="选择日期" ></el-date-picker>
    ...
    <el-dialog title="编辑客户投资表" v-model="dialogFormVisible" size="tiny">
...
import { fmoney } from '../../util/fmoney';
import { fdate } from '../../util/fdate';
export default {
    data() {
            return {
                getdataurl: this.GLOBAL.baseurl + 'tCustomerInvest/getId.do',
                getbankurl:this.GLOBAL.baseurl + 'tCustomerInvest/getBanks.do',
                getchannelurl:this.GLOBAL.baseurl + 'tCustomerInvest/getChannels.do',
                dataurl: this.GLOBAL.baseurl + 'tCustomerInvest/dataList.do',
                saveurl: this.GLOBAL.baseurl + 'tCustomerInvest/save.do',
                deleteurl: this.GLOBAL.baseurl + 'tCustomerInvest/delete.do',
