...
<div class="table">
    <div class="crumbs">
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>渠道数据统计</el-breadcrumb-item>
        </el-breadcrumb>
    </div>
	...
	-->
    <el-dialog title="编辑客户来源表" v-model="dialogFormVisible" size="tiny">
...
export default {
    data() {
            return {
                getdataurl: this.GLOBAL.baseurl + 'tCustomerFrom/getId.do',
                dataurl: this.GLOBAL.baseurl + 'tCustomerFrom/dataList.do',
                saveurl: this.GLOBAL.baseurl + 'tCustomerFrom/save.do',
                deleteurl: this.GLOBAL.baseurl + 'tCustomerFrom/delete.do',
                searchurl: this.GLOBAL.baseurl + 'tCustomerFrom/searchlist.do',
