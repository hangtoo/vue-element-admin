...
<template>
    <div class="table">
        ...
        <el-dialog title="编辑参数" v-model="dialogFormVisible" size="tiny">
...
<script>
    ...
    export default {
        data() {
            return {
                getdataurl: this.GLOBAL.baseurl + 'extConfigparam/getId.do',
                dataurl: this.GLOBAL.baseurl + 'extConfigparam/dataList.do',
                saveurl: this.GLOBAL.baseurl + 'extConfigparam/save.do',
                deleteurl: this.GLOBAL.baseurl + 'extConfigparam/delete.do',
