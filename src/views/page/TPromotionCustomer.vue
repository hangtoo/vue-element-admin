...
<div class="table">
    <div class="crumbs">
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>活动参与表</el-breadcrumb-item>
        </el-breadcrumb>
    </div>
    ...
    <el-dialog title="编辑活动参与表" v-model="dialogFormVisible" size="tiny">
...
export default {
    data() {
            return {
                getdataurl: this.GLOBAL.baseurl + 'tPromotionCustomer/getId.do',
                dataurl: this.GLOBAL.baseurl + 'tPromotionCustomer/dataList.do',
                saveurl: this.GLOBAL.baseurl + 'tPromotionCustomer/save.do',
                deleteurl: this.GLOBAL.baseurl + 'tPromotionCustomer/delete.do',
