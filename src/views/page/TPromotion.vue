...
<div class="table">
    ...
    <div class="handle-box">
		<span>活动名称：</span> <el-input v-model="searchForm.promotion_name"  class="handle-input mr10"></el-input>
		<span>&#12288活动编号：</span><el-input v-model="searchForm.promotion_id"  type="number" class="handle-input mr10"></el-input>
		<span>&#12288创建时间：</span><el-date-picker v-model="searchForm.searchbegintime":editable="false" type="datetime"  ></el-date-picker>
		<span>&#12288-&#12288</span><el-date-picker v-model="searchForm.searchendtime":editable="false" type="datetime"  ></el-date-picker>	    		   
        <el-button type="primary" icon="search" @click="handleSearch">搜索</el-button>
        <el-button type="primary" icon="search" @click="handleReset">重置</el-button>
    </div>
    
    <div class="handle-box">
		<el-button size="primary" type="info"  @click="handleLook">查看</el-button>
		<el-button size="primary" type="add"  @click="handleAdd">新增</el-button>
		<el-button size="primary" type="warning" @click="handleEdit">编辑</el-button>
		<el-button size="primary" type="danger" @click="handleDelete">删除</el-button>
    </div>
    ...
    <el-dialog title="查看" v-model="dialogLookVisible" >
    ...
    <el-dialog  title="活动管理"  v-model="dialogFormVisible" size="tiny">
        <el-form v-loading="loading":ref="editForm" :model="editForm":rules="rules" label-width="100px">
            ...
            <el-select v-model="editForm.promotion_type"  clearable filterable placeholder="请选择活动类型">
				<el-option
...
export default {
    data() {
            return {
                getdataurl: this.GLOBAL.baseurl + 'tPromotion/getId.do',
                dataurl: this.GLOBAL.baseurl + 'tPromotion/dataList.do',
                saveurl: this.GLOBAL.baseurl + 'tPromotion/save.do',
                savedetailurl: this.GLOBAL.baseurl + 'tPromotion/savedetail.do',
                deleteurl: this.GLOBAL.baseurl + 'tPromotion/delete.do',
                lookurl: this.GLOBAL.baseurl + 'tPromotionCustomer/dataList.do',
