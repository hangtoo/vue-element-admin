...
<div class="table">
    <div class="crumbs">
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>用户银行风险表</el-breadcrumb-item>
        </el-breadcrumb>
    </div>
    ...
    <el-dialog title="编辑用户银行风险表" v-model="dialogFormVisible" size="tiny">
...
export default {
    data() {
            return {
                getdataurl: this.GLOBAL.baseurl + 'tCustomerBankRisk/getId.do',
                dataurl: this.GLOBAL.baseurl + 'tCustomerBankRisk/dataList.do',
                saveurl: this.GLOBAL.baseurl + 'tCustomerBankRisk/save.do',
                deleteurl: this.GLOBAL.baseurl + 'tCustomerBankRisk/delete.do',
