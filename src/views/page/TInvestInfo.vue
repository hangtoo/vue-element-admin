...
<div class="table">
    ...
    <div class="handle-box">
        <el-row :gutter="20">
          ...
          <el-col :span="5">
            <div class="grid-content">
              <span>银行:</span>
              <el-select v-model="searchForm.bank_no" class="handle-select mr10" placeholder="请选择">
                <el-option v-for="option in bank_options" :key="option.bank_no" :value="option.bank_no" :label="option.bank_name">
                </el-option>
              </el-select>
            </div>
          </el-col>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="5">
            <div class="grid-content">
              <span>状态:</span>
              <el-select v-model="searchForm.status" class="handle-select mr10" placeholder="请选择">
                <el-option v-for="option in status_options" :key="option.bank_no" :value="option.value" :label="option.label">
                </el-option>
              </el-select>
            </div>
          </el-col>
    ...
    <el-dialog title="产品基本信息" v-model="dialogFormVisible" width="120%">
            <el-row :gutter="20">
              <el-col :span="8">
...
import countDown from '../../views/common/countDown.vue';
import { fmoney } from '../../util/fmoney';
export default {
    data() {
            return {
                getdataurl: this.GLOBAL.baseurl + 'tInvestInfo/getId.do',
                getbankurl:this.GLOBAL.baseurl + 'tInvestInfo/getBanks.do',
                dataurl: this.GLOBAL.baseurl + 'tInvestInfo/dataList.do',
                saveurl: this.GLOBAL.baseurl + 'tInvestInfo/save.do',
                deleteurl: this.GLOBAL.baseurl + 'tInvestInfo/delete.do',
                lookurl: this.GLOBAL.baseurl + 'tInvestInfo/look.do',
        ...
        methods: {
                ...
                handleLook(){
                  let self = this;
                  self.dialogFormVisible = true;
                  http.post(self.lookurl + '?id=' + self.rowData.id, {},(res) => {
