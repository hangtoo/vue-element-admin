...
<div class="table">
    <div class="crumbs">
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>客户基本信息表</el-breadcrumb-item>
        </el-breadcrumb>
    </div>
    ...
    <div class="handle-box">
       <el-button size="primary" type="info"  @click="handleLookDetail">查看</el-button>
    </div>
    ...
    <el-table :data="data" border fit highlight-current-row style="width: 100%" ref="singleTable" @sort-change="handleSort">
        ...
        <el-table-column prop="custom_no" label="泛泰UID" min-width="170" align="center">
        </el-table-column>
        ...
        <el-table-column prop="custom_idcard" label="客户身份证" width="190" align="center">
        </el-table-column>
        
        <el-table-column prop="channel_info" label="流量渠道(UID)"  min-width="150">
        </el-table-column>
	    	
	    			    		    	
         <el-table-column prop="custom_mobile" label="客户手机号"min-width="140" align="center">
        </el-table-column>
         <el-table-column prop="flag" label="用户状态" min-width="150" align="center">
        </el-table-column>
    ...
    <el-dialog title="编辑客户基本信息表" v-model="dialogFormVisible" size="tiny">
    ...
    <el-dialog title="用户详情" v-model="dialogLookVisible" >
...
export default {
    data() {
            return {
                getdataurl: this.GLOBAL.baseurl + 'tCustomer/getId.do',
                dataurl: this.GLOBAL.baseurl + 'tCustomer/dataList.do',
                saveurl: this.GLOBAL.baseurl + 'tCustomer/save.do',
                deleteurl: this.GLOBAL.baseurl + 'tCustomer/delete.do',
                detailurl: this.GLOBAL.baseurl + 'tCustomer/customerdetail.do',
                moneyurl: this.GLOBAL.baseurl + 'tCustomer/customermoney.do',
                ...
                handleLookDetail(){
                	...
                	if(self.radio){
	                	http.post(self.detailurl, {
	    				    custom_no:self.rowData.custom_no,
		                    },response => {
