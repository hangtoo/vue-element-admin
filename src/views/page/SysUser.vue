...
export default {
    data() {
            return {
                dataurl: this.GLOBAL.baseurl + 'sysUser/dataList.do',
                saveurl: this.GLOBAL.baseurl + 'sysUser/save.do',
                deleteurl: this.GLOBAL.baseurl + 'sysUser/delete.do',
                getdataurl: this.GLOBAL.baseurl + 'sysUser/getId.do',
                updatepwdurl: this.GLOBAL.baseurl + 'sysUser/updatePwd.do',
                roledataurl: this.GLOBAL.baseurl + 'sysRole/dataList.do',
                checkdataurl: this.GLOBAL.baseurl + 'sysRole/dataList.do',
                departmentdataurl: this.GLOBAL.baseurl + 'sysDepartment/dataList.do',
                departmenttreeurl: this.GLOBAL.baseurl + 'sysDepartment/getDepartmentTable.do',
